import { useAddMovieMutation, useGetAllGenresQuery } from "../components/queries/movie";
    ...
    <div>
      ...
      <form className="form">
        ...
        <fieldset>
          ...
          {
            genres.map(
                (c) => <label key={c.id}><input type="checkbox" value={c.id} name="genre_ids" {...register("genre_ids")} />{c.name}</label>
            )
          }
        </fieldset>
